...
def init_db():
    ...
    # Create tables with unique constraint on (email, user_type) combination --> same email can be used for different user_type values (e.g., "Recruiter" and "Candidate")
    c.execute('''CREATE TABLE IF NOT EXISTS users (
        ...
        CONSTRAINT unique_email_user_type UNIQUE (email, user_type)         
    )''')
